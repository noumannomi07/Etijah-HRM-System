...
const PendingEdits = ({ data, isPending }: PendingEditsProps) => {
    ...
    const handleApprove = (id: number) => {
        updateStatus(
            { attendance_id: id, status: "approved" },
            {
                onSuccess: () => {
                    toast.success(
                        t("approve_success", "تم الموافقة على التعديل بنجاح")
                    );
                },
                onError: () => {
                    toast.error(
                        t("approve_error", "حدث خطأ أثناء الموافقة على التعديل")
                    );
                },
            }
        );
    ...
    const handleReject = (id: number) => {
        updateStatus(
            { attendance_id: id, status: "rejected" },
            {
                onSuccess: () => {
                    toast.success(t("reject_success", "تم رفض التعديل بنجاح"));
                },
                onError: () => {
                    toast.error(t("reject_error", "حدث خطأ أثناء رفض التعديل"));
                },
            }
        );
    };
