...
import ModalCheckedButton from "./Components/ModalCheckedButton/ModalCheckedButton";
...
import SelectTypeVacation from "../../AllSelectsForm/SelectTypeVacation";
...
interface FormValues {
  ...
  selectVacation: { value: string; label: string } | null;
}
...
const ModalFilterData: React.FC<ModalFilterDataProps> = ({ open, hiddenModal }) => {
  ...
  const validationSchema = Yup.object({
    ...
    selectVacation: Yup.object().nullable().required(t("validation.vacationTypeRequired")),
  });
          ...
          {({ handleSubmit, setFieldValue, errors, touched }) => (
            <Form>
              <div className="all-forms-grid grid-cards-2">
                ...
                {/* ================== START INPUT ONE DETAILS ================== */}
                <div className="input-one-details">
                  <Field name="selectVacation">
                    {({ field }: FieldProps) => (
                      <SelectTypeVacation
                        setFieldValue={setFieldValue}
                        field={field}
                        error={touched.selectVacation && errors.selectVacation}
                      />
                    )}
                  </Field>
                </div>
