...
interface ModalFilterLetterRequestsProps {
  open: boolean;
  hiddenModal: () => void;
}
...
const ModalFilterLetterRequests: React.FC<ModalFilterLetterRequestsProps> = ({ open, hiddenModal }) => {
...
ModalFilterLetterRequests.propTypes = {
  open: PropTypes.bool.isRequired,
  hiddenModal: PropTypes.func.isRequired,
};

export default ModalFilterLetterRequests;
