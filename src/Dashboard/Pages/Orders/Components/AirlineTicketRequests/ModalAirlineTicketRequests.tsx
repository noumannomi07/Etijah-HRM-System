...
import SelectRequest from "../AllSelectsForm/SelectRequest";
import { useTranslation } from "react-i18next";

interface ModalAirlineTicketRequestsProps {
  open: boolean;
  hiddenModal: () => void;
}
...
const ModalAirlineTicketRequests: React.FC<ModalAirlineTicketRequestsProps> = ({ open, hiddenModal }) => {
  ...
  const validationSchema = Yup.object({
    ...
    leaveType: Yup.object().nullable().required(t("validation.requestTypeRequired")),
  });
...
ModalAirlineTicketRequests.propTypes = {
  open: PropTypes.bool.isRequired,
  hiddenModal: PropTypes.func.isRequired,
};

export default ModalAirlineTicketRequests;
