...
function FormComponent({
  ...
  const validationSchema = Yup.object({
    ...
    months: Yup.number()
      .required(t("advanceManagement.form.validation.months_required"))
      .positive(t("advanceManagement.form.validation.months_positive"))
  });
        ...
        <Form>
          <div className="all-forms-grid grid-cards-2">
            ...
            <div className="input-one-details">
              <InputField
                isShowLabel={true}
                label={t("advanceManagement.form.fields.repaymentPeriod")}
                name={"months"}
                type={"number"}
                placeholder={t(
                  "advanceManagement.form.fields.number_repayment_period"
                )}
                success
