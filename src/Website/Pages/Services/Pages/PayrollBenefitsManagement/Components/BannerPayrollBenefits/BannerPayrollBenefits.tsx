...
import img04 from "@assets/images/website/services/imagesservices/followupperformance/a05.png";
import WebSectionTitle from "@/Website/Shared/WebSectionTitle/WebSectionTitle";
import { useTranslation } from "react-i18next";

const BannerPayrollBenefits = () => {
  ...
  return (
    <div className="all-cards-banner-details-payroll padding-60-web">
      <WebSectionTitle
        dataAos="fade-up"
...
export default BannerPayrollBenefits;
